 ...
 */
class PrepaidClaimController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('claims::prepaid-claims.index', compact('claims'));
    }
    ...
    public function create()
    {
        ...
        return view('claims::prepaid-claims.create', compact(
            'hospital',
            'department',
            'entities',
            'allHospitals',
    ...
    public function edit(Claim $claim)
    {
        ...
        return view('claims::prepaid-claims.edit', compact('claim', 'entities', 'allHospitals', 'allDepartments', 'departments'));
    }
