            ...
            <div class="form-row-4">
                ...
                <div class="form-group">
                    ...
                    <select name="entity_id" class="form-control" required>
                        ...
                        <option value="{{ $entity->id }}" {{ old('entity_id', session('flow_options.entity_id')) == $entity->id ? 'selected' : '' }}>
                            {{ $entity->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="form-row-4">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" id="claimValue" name="claim_value"
                            class="form-control" min="0" value="{{ old('claim_value') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" id="reviewedValue" name="reviewed_value"
                            class="form-control" min="0" value="{{ old('reviewed_value') }}"
