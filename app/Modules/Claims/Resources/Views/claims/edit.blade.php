...
<div class="page-header">
    <h1 class="page-title"><i class="fa-solid fa-edit"></i> تعديل مطالبة <span style="color: var(--primary-color);">#{{ $claim->id }}</span></h1>
            ...
            <div class="form-section" style="padding: 20px;">
                ...
                <div class="form-row-4">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" id="claimValue" name="claim_value"
                            class="form-control" min="0" value="{{ old('claim_value', $claim->claim_value) }}"
                            required oninput="calculateDiff()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" id="reviewedValue" name="reviewed_value"
                            class="form-control" min="0" value="{{ old('reviewed_value', $claim->reviewed_value) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" id="differenceValue" name="difference"
                            class="form-control" value="{{ $claim->difference }}" readonly>
                    </div>
                ...
                <div class="file-list" style="margin-top: 10px;">
                    ...
                    <div class="file-item">
                        ...
                        <div class="file-actions">
                            <a href="{{ asset('storage/' . $path) }}" target="_blank" class="attachment-badge" style="background: #f1f5f9; color: #64748b; width: 36px; height: 36px; border-radius: 10px; display: flex; align-items: center; justify-content: center; text-decoration: none;">
