...
@section('title', 'أوامر الدفع المسبق')
...
@section('content')
    ...
    <div class="breadcrumb-nav">
        ...
        <span class="breadcrumb-separator"><i class="fa-solid fa-chevron-left"></i></span>
        <span class="breadcrumb-item active">أوامر الدفع المسبق المسبق</span>
    </div>

    <div class="page-header">
        <h1 class="page-title"><i class="fa-solid fa-credit-card"></i> أوامر الدفع المسبق</h1>
        @can('create', App\Modules\Claims\Models\PaymentOrder::class)
            <a href="{{ route('prepaid-payments.create') }}" class="btn btn-primary" style="margin-top: 0;">
                <i class="fa-solid fa-plus"></i> إضافة أمر دفع مسبق
            </a>
        @endcan
    </div>
                    ...
                    <tr style="{{ $isNew ? 'background-color: #f0fdf4; border-right: 4px solid #22c55e;' : '' }}">
                        ...
                        <td style="text-align: center;">
                            <div style="display: flex; gap: 8px; justify-content: center;">
                                @can('update', $order)
                                    <a href="{{ route('prepaid-payments.edit', $order->id) }}" class="btn-action"
                                ...
                                @can('delete', $order)
                                    <form action="{{ route('prepaid-payments.destroy', $order->id) }}" method="POST"
