...
@section('content')
    ...
    <div class="breadcrumb-nav">
        ...
        <a href="{{ route('prepaid-payments.index') }}" class="breadcrumb-item">أوامر الدفع المسبق المسبق</a>
        <span class="breadcrumb-separator"><i class="fa-solid fa-chevron-left"></i></span>
    ...
    <div class="form-container">
        <div class="form-card">
            <form action="{{ route('prepaid-payments.update', $payment->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
