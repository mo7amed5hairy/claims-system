...
@section('title', 'مطالبات الدفع المسبق')
...
@section('content')
    <div class="page-header">
        <h1 class="page-title"><i class="fa-solid fa-file-invoice-dollar"></i> مطالبات الدفع المسبق</h1>
        @can('create', App\Modules\Claims\Models\Claim::class)
        <a href="{{ route('prepaid-claims.create') }}" class="btn btn-primary" style="margin-top: 0;">
            <i class="fa-solid fa-plus"></i> إضافة مطالبة دفع مسبق جديدة
        </a>
        @endcan
    </div>
                    ...
                    <tr style="{{ $isNew ? 'background-color: #f0fdf4; border-right: 4px solid #22c55e;' : '' }}">
                        ...
                        <td style="text-align: center;">
                            <div style="display: flex; gap: 8px; justify-content: center;">
                                @can('update', $claim)
                                <a href="{{ route('prepaid-claims.edit', $claim->id) }}" class="btn-action"
                                ...
                                @can('delete', $claim)
                                <form action="{{ route('prepaid-claims.destroy', $claim->id) }}" method="POST" style="display: inline;"
