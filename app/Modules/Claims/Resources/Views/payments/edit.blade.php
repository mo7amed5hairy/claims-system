        ...
        <form action="{{ route('payments.update', $payment->id) }}" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="gp_number" class="form-control" value="{{ old('gp_number', $payment->gp_number) }}" required>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="due_date" class="form-control" value="{{ old('due_date', $payment->due_date->format('Y-m-d')) }}" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="payer_entity_id" class="form-control" required>
                        ...
                        <option value="{{ $entity->id }}" {{ old('payer_entity_id', $payment->payer_entity_id) == $entity->id ? 'selected' : '' }}>{{ $entity->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="electronic_invoice_no" class="form-control" value="{{ old('electronic_invoice_no', $payment->electronic_invoice_no) }}">
