        ...
        <form action="{{ route('returns.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-row-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="electronic_invoice_no" class="form-control" value="{{ old('electronic_invoice_no') }}" required placeholder="مثلاً: 25-100-2026">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="returned_invoice_count" class="form-control" value="{{ old('returned_invoice_count', 1) }}" min="1" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="reviewer_name" class="form-control" value="{{ old('reviewer_name') }}" placeholder="اسم المراجع المختص">
            ...
            <div class="form-section">
                ...
                <div class="form-row-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" id="reviewed_value" name="reviewed_value" class="form-control" value="{{ old('reviewed_value') }}" required oninput="calculateFinal()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" id="discount_amount" name="discount_amount" class="form-control" value="{{ old('discount_amount', 0) }}" oninput="calculateFinal()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" id="tax_amount" name="tax_amount" class="form-control" value="{{ old('tax_amount', 0) }}" oninput="calculateFinal()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" id="final_amount" name="final_amount" class="form-control" readonly value="{{ old('final_amount') }}">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="reason" class="form-control" rows="3" placeholder="أدخل سبب ارتجاع الفاتورة أو أي ملاحظات إضافية...">{{ old('reason') }}</textarea>
                    @error('reason') <span class="error-message">{{ $message }}</span> @enderror
                </div>

                <div class="form-group" style="margin-top: 20px;">
                    <label class="form-label"><i class="fa-solid fa-cloud-upload-alt"></i> المرفقات (صور، PDF، Excel)</label>
